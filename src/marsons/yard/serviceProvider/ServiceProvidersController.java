 ...
 */
package marsons.yard.serviceProvider;
...
public class ServiceProvidersController implements Initializable {
    ...
    @FXML
    private TableView miscPartyTable;
    @FXML
...
public void vendorTable() {
        ...
        try {
            ...
            String SQL = "SELECT Name,Balance from miscparty";
            ...
            for (int i = 0; i < rs.getMetaData().getColumnCount(); i++) {
                ...
                miscPartyTable.getColumns().addAll(col);
