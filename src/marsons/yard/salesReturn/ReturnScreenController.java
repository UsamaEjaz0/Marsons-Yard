...
public class ReturnScreenController implements Initializable {
    ...
    void handleAction(ActionEvent event) throws IOException {
        if (event.getSource() == addSale) {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("AddReturn.fxml"));
...
//                              
                                ...
                                Logger.getLogger(ReturnScreenController.class.getName()).log(Level.SEVERE, null, ex);
                            }
