 ...
 * @author uejaz
 */
public class SalesPaymentInController implements Initializable {
    ...
    public void paymentInTable() {
        ...
        try {
            ...
            String SQL = "SELECT * from paymentin";
            ...
            for (int i = 0; i < rs.getMetaData().getColumnCount(); i++) {
                ...
                paymentInTable.getColumns().addAll(col);
