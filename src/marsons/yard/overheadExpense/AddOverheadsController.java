 ...
 */
package marsons.yard.overheadExpense;
 ...
 * @author uejaz
 */
public class AddOverheadsController implements Initializable {
...
@FXML
    void handleAction(ActionEvent event) throws SQLException {
        ...
        if(event.getSource()== save){
            String query = "INSERT INTO `overheads`(`type`, `category`, `itemName`, `description`, `date`, `quantity`, `pricePerUnit`, `amount`, `paymentType`) "
